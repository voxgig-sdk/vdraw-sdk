...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/vdraw` | `npm install @voxgig-sdk/vdraw` |
| Python | `voxgig-sdk-vdraw` | `pip install voxgig-sdk-vdraw` |
| PHP | `voxgig-sdk/vdraw` | `composer require voxgig-sdk/vdraw` |
| Golang | `github.com/voxgig-sdk/vdraw-sdk/go` | `go get github.com/voxgig-sdk/vdraw-sdk/go` |
| Ruby | `voxgig-sdk-vdraw` | `gem install voxgig-sdk-vdraw` |
| Lua | `voxgig-sdk-vdraw` | `luarocks install voxgig-sdk-vdraw` |

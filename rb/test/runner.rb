...
module VdrawTestRunner
  ...
  def self.env_override(m)
    live = getenv("VDRAW_TEST_LIVE")
    override = getenv("VDRAW_TEST_OVERRIDE")
    ...
    explain = getenv("VDRAW_TEST_EXPLAIN")
    m["VDRAW_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = VdrawTestRunner
Helpers = VdrawHelpers
Vs = VoxgigStruct

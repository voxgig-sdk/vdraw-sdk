...
VdrawSDK._make_feature = _make_feature


function VdrawSDK.new(options)
  local self = setmetatable({}, VdrawSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function VdrawSDK:get_utility()
  return Utility.copy(self._utility)
end


function VdrawSDK:get_root_ctx()
  return self._rootctx
end


function VdrawSDK:prepare(fetchargs)
...
function VdrawSDK:direct(fetchargs)
...
-- by passing it.
function VdrawSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function VdrawSDK:graphql(query, variables, ctrl)
...
-- Idiomatic facade: client:UsernameGeneration():list() / client:UsernameGeneration():load({ id = ... })
...
function VdrawSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = VdrawSDK.new(sdkopts)
  sdk.mode = "test"

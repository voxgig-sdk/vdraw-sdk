...
local UsernameGenerationEntity = {}
UsernameGenerationEntity.__index = UsernameGenerationEntity


function UsernameGenerationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UsernameGenerationEntity)
  self._name = "username_generation"
  self._client = client
...
function UsernameGenerationEntity:get_name()
  return self._name
end


function UsernameGenerationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return UsernameGenerationEntity.new(self._client, opts)
end
...
function UsernameGenerationEntity:mark_deleted()
  self._deleted = true
end


function UsernameGenerationEntity:deleted()
  return true == self._deleted
end


function UsernameGenerationEntity:data_set(args)
  if args ~= nil then
...
function UsernameGenerationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UsernameGenerationEntity:match_set(args)
  if args ~= nil then
...
function UsernameGenerationEntity:match_get()
...
function UsernameGenerationEntity:stream(action, args, callopts)
...
---@param reqdata UsernameGenerationCreateData
---@param ctrl? table
---@return UsernameGeneration
---@return string? err
function UsernameGenerationEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function UsernameGenerationEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return UsernameGenerationEntity

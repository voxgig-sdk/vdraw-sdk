...
class VdrawTimeoutFeature extends VdrawBaseFeature
{
    ...
    private function _with_timeout(VdrawContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(VdrawContext $_ctx, float $ms): void
    {
        $client = $this->client;

...
class VdrawCacheFeature extends VdrawBaseFeature
{
    ...
    private function _through(VdrawContext $ctx, string $url, array $fetchdef, callable $inner): array
    {

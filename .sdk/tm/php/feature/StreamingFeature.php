...
class VdrawStreamingFeature extends VdrawBaseFeature
{
    ...
    private function _iterate(VdrawResult $result): \Generator
    {
    ...
    private function _streamable(VdrawContext $ctx): bool
    {

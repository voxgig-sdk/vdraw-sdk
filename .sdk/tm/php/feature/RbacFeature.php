...
class VdrawRbacFeature extends VdrawBaseFeature
{
    ...
    private function _required(VdrawContext $ctx): ?string
    {
    ...
    private function _reject(VdrawContext $ctx, string $required): void
    {
    ...
    private function _track(VdrawContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;

...
class VdrawTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = VdrawTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = VdrawTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = VdrawTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")

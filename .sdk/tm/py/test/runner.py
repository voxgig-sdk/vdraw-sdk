...
class VdrawTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = VdrawTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = VdrawTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = VdrawTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")

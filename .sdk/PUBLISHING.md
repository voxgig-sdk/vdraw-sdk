...
|---|---|---|
| `ts/` | @voxgig-sdk/vdraw-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/vdraw-sdk \
      --repository voxgig-sdk/vdraw-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/vdraw-sdk` shows it, and
`npm trust revoke @voxgig-sdk/vdraw-sdk --id=<id>` removes it.

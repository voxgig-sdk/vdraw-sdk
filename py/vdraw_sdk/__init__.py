...
from vdraw_sdk.utility import register

# Load features
from vdraw_sdk.feature.base_feature import VdrawBaseFeature
from vdraw_sdk.features import _has_feature, _make_feature
...
class VdrawSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = VdrawUtility()
        self._utility = utility

        from vdraw_sdk.config import shared_config
    ...
    def get_utility(self):
        return VdrawUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("VdrawSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def UsernameGeneration(self, data=None) -> "UsernameGenerationEntity":
        ...
        from vdraw_sdk.entity.username_generation_entity import UsernameGenerationEntity

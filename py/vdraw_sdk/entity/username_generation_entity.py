...
from vdraw_sdk.vdraw_types import (
    UsernameGeneration,
...
class UsernameGenerationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return UsernameGenerationEntity(self._client, opts)
    ...
    def data_get(self) -> UsernameGeneration:
    ...
    def match_get(self) -> UsernameGeneration:
    ...
    def create(self, reqdata: UsernameGenerationCreateData, ctrl=None) -> UsernameGeneration:
        utility = self._utility

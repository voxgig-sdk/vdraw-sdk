...
from vdraw_sdk.core.helpers import get_ctx_prop, to_map
...
class VdrawContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, VdrawResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return VdrawError(code, msg, self)

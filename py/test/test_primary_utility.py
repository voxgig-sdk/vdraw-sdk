...
from vdraw_sdk.core.response import VdrawResponse
from vdraw_sdk.core.operation import VdrawOperation
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = VdrawSDK.test(None, None)
        ...
        class TestInitFeature(VdrawBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(VdrawBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = VdrawSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = VdrawSDK.test(None, setup_opts)

# Vdraw SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions VdrawSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both VdrawSDK(...) and VdrawSDK.test(...) become
#      VdrawSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_ENTITIES = {
    "UsernameGeneration": "username_generation",
}

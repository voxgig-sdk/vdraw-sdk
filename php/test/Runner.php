...
class VdrawTestRunner
{
    ...
    {
        $live = self::getenv('VDRAW_TEST_LIVE');
        $override = self::getenv('VDRAW_TEST_OVERRIDE');
        ...
        $explain = self::getenv('VDRAW_TEST_EXPLAIN');
...
class_alias('VdrawTestRunner', 'Runner');
class_alias('VdrawHelpers', 'Helpers');

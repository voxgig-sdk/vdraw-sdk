...
// Vdraw SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (VdrawSDK::test)
...
{
    private const SDK_CLASS = 'VdrawSDK';
    ...
    private const SDK_BASE = 'vdraw_sdk';

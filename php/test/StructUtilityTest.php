...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = VdrawOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(VdrawOmni::structfix($now, Struct::undef()))
                        !== json_encode(VdrawOmni::structfix($val, Struct::undef()))) {

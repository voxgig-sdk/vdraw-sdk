...
class VdrawRatelimitFeature extends VdrawBaseFeature
{
    ...
    private function _acquire(VdrawContext $ctx): void
    {
    ...
    private function _track(VdrawContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;

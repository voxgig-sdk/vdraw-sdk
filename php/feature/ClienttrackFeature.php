...
class VdrawClienttrackFeature extends VdrawBaseFeature
{
    ...
    public function PostConstruct(VdrawContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Vdraw-SDK';

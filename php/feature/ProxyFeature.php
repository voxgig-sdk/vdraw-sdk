...
class VdrawProxyFeature extends VdrawBaseFeature
{
    ...
    public function init(VdrawContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (VdrawContext $ctx2, string $url2, array $fetchdef) use ($inner): array {

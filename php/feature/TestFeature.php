...
// Vdraw SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class VdrawTestFeature extends VdrawBaseFeature
{
    ...
    public function init(VdrawContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (VdrawContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (VdrawContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(VdrawContext $ctx, $op, $args): array
    {

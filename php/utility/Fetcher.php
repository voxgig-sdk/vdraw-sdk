...
class VdrawFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; VdrawSDK/1.0)';
    ...
    public static function call(VdrawContext $ctx, string $fullurl, array $fetchdef): array
    {

...
// Vdraw SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class VdrawMakeRequest
{
    public static function call(VdrawContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new VdrawResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new VdrawResponse($fetched);
        } else {

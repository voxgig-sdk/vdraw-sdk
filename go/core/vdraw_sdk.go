...
func (sdk *VdrawSDK) OptionsMap() map[string]any {
...
func (sdk *VdrawSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *VdrawSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *VdrawSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *VdrawSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *VdrawSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *VdrawSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("VdrawSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *VdrawSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *VdrawSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("VdrawSDK: graphql: %s", msg)
		res["graphql"] = errors
	}

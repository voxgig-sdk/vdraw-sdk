...
AQL-driven CLI and REPL for the Vdraw SDK. Positional arguments are
...
./vdraw-cli list username_generation
./vdraw-cli load 1 username_generation
./vdraw-cli load '{id:1}' username_generation
